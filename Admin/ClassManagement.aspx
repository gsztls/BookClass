<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClassManagement.aspx.cs" Inherits="ClassList" %>
...
<body>
    ...
    <form id="Form1" runat="server" style="background:#fff">
		...
		<div class="reserve-content" style = "height:800px">
				<div id="info4" style="margin-left:10px">
				...
				<div id="info5">
                    ...
                    <asp:GridView ID="GridView_BookList" runat="server" Height="89px" 
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                   <table  border="0"><tr><td><asp:Button ID="Button2" runat="server" Text="添加教室" Width="83px" 
                                           BackColor="#0099FF" onclick="Button2_Click" /></td>
                                       <td class="style3"></td></tr></table> 
                                </HeaderTemplate>
                                <ItemTemplate>
                                     <table border="0"><tr><td class="style2">
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Address") %>'></asp:Label></td>
                                         <td class="style1">
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("ClassNum") %>'></asp:Label></td>
                                         <td class="style5"><asp:LinkButton ID="LinkButton2" runat="server" CommandName="Delete">删除</asp:LinkButton></td>
                                        </tr></table>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
				    ...
				    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:BookClassConnectionString %>" 
                        SelectCommand="SELECT [Address], [ClassNum], [ID] FROM [ClassList]">
                    </asp:SqlDataSource>
				</div>
		</div>
	</div>
