<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddClass.aspx.cs" Inherits="ClassList" %>
...
<body>
    <header>
		<div class="logo">
			...
			<h1 class="vertical-center">教室预约管理</h1>
		</div>
		<div class="logoff">
		...
		<div class="reserve-content">
				...
				<div id="info5">
                    ...
                    <asp:GridView ID="GridView_BookList" runat="server" Height="89px" 
                        ...
                        onrowupdating="GridView_BookList_RowUpdating" DataKeyNames="ID">
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <table><tr><td><asp:TextBox ID="TextBox1" runat="server" 
                                        Text='<%# Bind("Address") %>' Width="187px"></asp:TextBox></td>
                                    <td class="style2"><asp:TextBox ID="TextBox2" runat="server" 
                                            Text='<%# Bind("ClassNum") %>' Width="209px"></asp:TextBox></td><td>
                                        <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Update">提交</asp:LinkButton></td>
                                    <td class="style5"> <asp:LinkButton ID="LinkButton4" runat="server" 
                                            CommandName="Cancel">取消</asp:LinkButton></td></tr></table>
                                ...
                                <ItemTemplate>
                                    ...
                                    <br />
                                    <br />
                                    教室地址：<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox><br />
                                    教室编号：<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox><br />
                                    <asp:Button ID="Button2" runat="server" Text="提交" CommandName="Update"  />
                                    <br />
                                    <br />
                                    <br />
                                    <br />
				    ...
				    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT TOP 1 [ID], [Address], [ClassNum] FROM [ClassList]">
                    </asp:SqlDataSource>
				</div>
		</div>
	</div>
