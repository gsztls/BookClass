<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookRecord.aspx.cs" Inherits="ContactManager" %>
			...
			<form id="Form1" runat="server">
				<div id="info1">
					...
					<asp:GridView ID="GridView_Contact" runat="server" Height="89px" 
                        ...
                        DataSourceID="SqlDataSource1" AllowPaging="True" PageSize="17" >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="BookDate" HeaderText="预约日期" 
                                SortExpression="BookDate" />
                            <asp:BoundField DataField="StartTime" HeaderText="开始时间" 
                                SortExpression="StartTime" />
                            <asp:BoundField DataField="EndTime" HeaderText="结束时间" 
                                SortExpression="EndTime" />
                            <asp:BoundField DataField="IsBooked" HeaderText="预约状态" 
                                SortExpression="IsBooked" />
                        </Columns>
				    ...
				    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [Address], [ClassNum], [BookDate], [StartTime], [EndTime], [IsBooked] FROM [BookList] WHERE ([BookStuNum] = @BookStuNum) ORDER BY [BookDate] DESC, [StartTime] DESC">
                        <SelectParameters>
                            <asp:SessionParameter Name="BookStuNum" SessionField="StuId" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
				</div>
				<div id="info3">
